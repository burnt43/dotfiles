...
alias eqpt_gui_msp_report_sanity_check="eqpt_gui_dev && RAILS_ENV=jcarson_dev bundle exec rake eqpt_gui:msp:report:sanity_check"
...
alias eqpt_gui_web="__activate_webapp__ eqpt_gui"
