...
set nocompatible
filetype off
set rtp+=~/.vim/bundle_jr/Vundle.vim
call vundle#begin()
...
hi Folded cterm=bold ctermfg=white ctermbg=234 guibg=#1c1c1c 
hi rubyTodo cterm=NONE ctermfg=black ctermbg=194 guibg=#d7ffd7
" ctermbg=234 guibg=#1c1c1c DARK GRAY
" ctermbg=17 guibg=#00005f NAVY BLUE
